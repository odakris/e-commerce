...
class SellForm(forms.Forms):
    ...
    description = forms.Textarea(label="Description", required=True)
    upload = forms.FileField(label="Image", upload_to=utils.user_directory_path)
